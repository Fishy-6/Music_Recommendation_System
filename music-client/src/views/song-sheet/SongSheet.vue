<template>
  <div class="play-list-container">
    ...
    <play-list :playList="allPlayList" path="song-sheet-detail"></play-list>
    <el-pagination
      class="pagination"
      background
...
export default defineComponent({
  ...
  setup() {
    ...
    //分页查询
    async function getsongListByPage(currentPage) {
      
      const result = ((await HttpManager.getsongListByPage(currentPage)) as ResponseBody).data;
    ...
    try {
      //getSongList();
      getsongListByPage(currentPage.value);
    } catch (error) {
      console.error(error);
    }
